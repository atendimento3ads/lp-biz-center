...
const csp=[
  ...
  "form-action 'self'",
  `script-src 'self' https://www.googletagmanager.com https://tagmanager.google.com https://spar-hazel.vercel.app ${unique(scriptHashes).join(' ')}`,
  "script-src-attr 'none'",
  `style-src 'self' https://tagmanager.google.com https://fonts.googleapis.com ${unique(styleHashes).join(' ')}`,
  "style-src-attr 'unsafe-inline'",
  "connect-src 'self' https://www.googletagmanager.com https://*.google-analytics.com https://*.google.com https://*.google.com.br https://www.googleadservices.com https://googleads.g.doubleclick.net https://pagead2.googlesyndication.com https://spar-hazel.vercel.app https://tagassistant.google.com",
  "img-src 'self' data: https://www.googletagmanager.com https://*.google-analytics.com https://*.google.com https://*.google.com.br https://*.g.doubleclick.net https://www.googleadservices.com https://pagead2.googlesyndication.com https://ssl.gstatic.com https://www.gstatic.com https://spar-hazel.vercel.app",
